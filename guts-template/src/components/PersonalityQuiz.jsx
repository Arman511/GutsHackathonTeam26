...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      { text: 'Somewhere cold', tags: ['caring', 'prepared', 'nurturing'] },
      {
        ...
        tags: ['funny', 'entertainer', 'mood-lifter'],
      },
      { text: 'Close to family', tags: ['wise', 'thoughtful', 'cryptic'] },
      {
        text: 'Anywhere with hiking',
        tags: ['chaotic', 'lovable', 'disaster'],
      },
  ...
  },
  {
    ...
    options: [
      {
        text: 'Trying something new like comedy class',
        tags: ['basic', 'nostalgic', 'crowd-pleaser'],
      },
      {
        text: 'Perfect time to redecorate my room',
        tags: ['bold', 'showoff', 'theatrical'],
      },
      {
        text: 'Picnic with friends',
        tags: ['scene-kid', 'nostalgic', 'emotional'],
      },
      {
        text: "As long as im outside, i'm good",
        tags: ['shy', 'observer', 'wallflower'],
      },
      {
        text: 'Outdoor concerts all the way',
        tags: ['shy', 'observer', 'wallflower'],
      },
    ],
  },
  {
    ...
    options: [
      {
        text: 'Lots of layers brrr - brave and reckless',
        tags: ['courageous', 'impulsive', 'hero-complex'],
      },
      ...
      {
        text: 'Whatever my mum buys me',
        tags: ['smart', 'quirky', 'pretentious'],
      },
    ],
  },
];
