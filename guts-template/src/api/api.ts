...
export async function login(data: LoginRequest): Promise<LoginResponse> {
  ...
  return request(
    '/api/auth/token',
    { method: 'POST', body: encodededData.toString() },
...
export async function addLocation(data: CreateLocationRequest) {
  return loggedInRequest('/api/locations/add_location', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export async function searchLocations(query: LocationSearchRequest) {
  return loggedInRequest(`/api/locations/location_search`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function getLocation(locationId: number) {
  return loggedInRequest(`/api/locations/location/${locationId}`, {
    method: 'GET',
  });
}

export async function getLocationsForEvent(eventId: number) {
  return loggedInRequest(`/api/locations/get_locations_for_event/${eventId}`, {
    method: 'GET',
  });
}
...
export async function getEventAttendees(eventId: number) {
  return loggedInRequest(`/api/events/event_attendees/${eventId}`, {
    method: 'GET',
  });
}

export async function getEventResult(eventId: number) {
  return loggedInRequest(`/api/results/get_result/${eventId}`, {
    method: 'GET',
  });
}
...
export async function getKeyword(keywordId: number) {
  return loggedInRequest(`/api/keywords/keyword/${keywordId}`, {
    method: 'GET',
  });
}

export async function createKeyword(data: CreateKeywordRequest) {
  return loggedInRequest('/api/keywords/create_keyword', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export async function attendEvent(
  ...
  return loggedInRequest(`/api/events/attend_event/${event_id}`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
export async function addUsersToEvent(
  event_id: number,
  user_ids: AddUsersToEventRequest
) {
  return loggedInRequest(`/api/events/add_users_to_event/${event_id}`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
